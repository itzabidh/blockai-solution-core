        ...
        <div class="max-w-[1280px] mx-auto px-6 lg:px-8">
            <div id="mainNavShell" class="glass-morphism border border-white/10 rounded-2xl h-20 px-6 lg:px-8 flex justify-between items-center">
                ...
                <div class="flex items-center gap-3">
                    <a href="/auth/" class="hidden md:inline-flex items-center px-5 py-2.5 rounded-xl border border-white/15 text-xs font-semibold uppercase tracking-[0.14em] text-slate-200 hover:border-cyan-400/60 hover:text-white transition">
                        Client Login
                    </a>
